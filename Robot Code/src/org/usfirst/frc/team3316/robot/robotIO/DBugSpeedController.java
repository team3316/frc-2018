...
public class DBugSpeedController {
    ...
    private GenericSpeedController sc;
     ...
     */
    public DBugSpeedController(Object sc, boolean reverse, int pdpChannel, double maxCurrent) {
	this.sc = new GenericSpeedController(sc);
     ...
     */
    public DBugSpeedController(Object sc, boolean reverse, int pdpChannel) {
	this.sc = new GenericSpeedController(sc);
	this.reverse = reverse;
	this.pdpChannel = pdpChannel;
	isSetLimit = false;
