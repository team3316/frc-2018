...
public class Actuators {
	...
	private void ElevatorActuatorA() {
		...
		elevatorShifter = new DoubleSolenoid((int) config.get("PCM_CAN_ID"),
				(int) Robot.config.get("ELEVATOR_SHIFTER_FORWARD"), (int) Robot.config.get("ELEVATOR_SHIFTER_REVERSE"));
	}
