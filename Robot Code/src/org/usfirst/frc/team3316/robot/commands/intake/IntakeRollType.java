...
public enum IntakeRollType {
	...
	private String leftConfigKey () {
		switch (this.type) {
		case 1: return "intake_rollIn_voltage";
		case 2: return "intake_rollOut_voltage";
		case 4: return "intake_directionalRollIn_leftVoltage";
		default: return "";
		}
	}
	...
	private String rightConfigKey () {
		...
		case 1: return "intake_rollIn_voltage";
		case 2: return "intake_rollOut_voltage";
		case 4: return "intake_directionalRollIn_rightVoltage";
		default: return "";
		}
	}
